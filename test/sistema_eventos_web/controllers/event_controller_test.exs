defmodule SistemaEventosWeb.EventControllerTest do
  use SistemaEventosWeb.ConnCase

  import SistemaEventos.EventsFixtures

  @create_attrs %{date: ~U[2026-03-18 21:20:00Z], description: "some description", title: "some title", location: "some location", total_slots: 42}
